...
/** La clase BuscarEditorial extiende de HttpServlet y su principal
 ...
 */
public class BuscarEditorial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Recogemos el parámetro 'editorial'
        ...
        List<String> librosEditorial = new ArrayList<>();
        librosEditorial = dao.consultarLibrosEditorial(editorial);
        String lista = "";
        ...
        for (int i = 0; i < librosEditorial.size(); i++) {
            lista = lista + librosEditorial.get(i) + "-";
        }
        try {
            out.println(lista);
        } finally {
